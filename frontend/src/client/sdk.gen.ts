...
import type {
  IdentityEvalGetIdentityEvalsData,
  IdentityEvalGetIdentityEvalsResponse,
  IdentityEvalGetChartDataData,
  IdentityEvalGetChartDataResponse,
  IdentityEvalModelGetAllModelsResponse,
  IdentityEvalModelCreateModelData,
  IdentityEvalModelCreateModelResponse,
  IdentityEvalModelGetModelData,
  IdentityEvalModelGetModelResponse,
  IdentityEvalModelUpdateModelData,
  IdentityEvalModelUpdateModelResponse,
  IdentityEvalModelDeleteModelData,
  IdentityEvalModelDeleteModelResponse,
  IdentityEvalModelUpdateDatasetKeysData,
  IdentityEvalModelUpdateDatasetKeysResponse,
  ItemsReadItemsData,
...
export class IdentityEvalService {
   ...
   * @throws ApiError
   */
  public static getIdentityEvals(
    data: IdentityEvalGetIdentityEvalsData = {},
  ): CancelablePromise<IdentityEvalGetIdentityEvalsResponse> {
  ...
  public static getChartData(
    data: IdentityEvalGetChartDataData = {},
  ): CancelablePromise<IdentityEvalGetChartDataResponse> {
    return __request(OpenAPI, {
      method: "GET",
...
export class IdentityEvalModelService {
  ...
  public static createModel(
    data: IdentityEvalModelCreateModelData,
  ): CancelablePromise<IdentityEvalModelCreateModelResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/identity-eval-model/",
  ...
  public static getModel(
    data: IdentityEvalModelGetModelData,
  ): CancelablePromise<IdentityEvalModelGetModelResponse> {
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static updateModel(
    data: IdentityEvalModelUpdateModelData,
  ): CancelablePromise<IdentityEvalModelUpdateModelResponse> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/api/v1/identity-eval-model/{ai_model_id}",
      path: {
  ...
  public static deleteModel(
    data: IdentityEvalModelDeleteModelData,
  ): CancelablePromise<IdentityEvalModelDeleteModelResponse> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/v1/identity-eval-model/{ai_model_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static updateDatasetKeys(
    data: IdentityEvalModelUpdateDatasetKeysData,
  ): CancelablePromise<IdentityEvalModelUpdateDatasetKeysResponse> {
    return __request(OpenAPI, {
      method: "PATCH",
